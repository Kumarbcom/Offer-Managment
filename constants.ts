...
export const PRODUCTS_BRANDS = ['Lapp', 'Eaton', 'Polycab', 'Mennakes', 'Luker', 'Hager', 'Partex', 'Others'] as const;
...
export const QUOTATION_STATUSES = ['Open', 'PO received', 'Partial PO Received', 'Expired', 'Lost', 'Under Review', 'Need Amendment'] as const;
