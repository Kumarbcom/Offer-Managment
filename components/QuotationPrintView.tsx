...
export const QuotationPrintView: React.FC<QuotationPrintViewProps> = ({ quotation, allQuotations, customer, salesPerson, logoUrl }) => {
                    ...
                    <table className="w-full text-left text-[10px] border-collapse">
                        <thead className="bg-slate-100 text-slate-900 font-extrabold border-b border-slate-400 uppercase tracking-wider text-[9px]">
                            <tr className="divide-x divide-slate-800">
                                ...
                                <th className="p-2 font-bold w-auto">Description</th>
                                ...
                                <th className="p-2 font-bold text-center w-28">Stock Status</th>
                            </tr>
                        </thead>
