...
export const QuotationPrintView: React.FC<QuotationPrintViewProps> = ({ quotation, customer, salesPerson }) => {
    ...
    // A simple function to convert number to words for the total amount
        ...
        <div className="bg-white p-8 font-sans text-xs text-black print-container">
            ...
            <div className="flex justify-between mb-4">
                ...
                <div className="text-right">
                    ...
                    <p><span className="font-bold">Enquiry Date:</span> {new Date(quotation.enquiryDate).toLocaleDateString('en-GB')}</p>
                </div>
            </div>
            ...
            <table className="w-full border-collapse border border-black mb-4">
                    ...
                    {quotation.details.map((item, index) => {
                        ...
                        return (
                            <tr key={index}>
                                ...
                                <td className="border border-black p-1 text-center">{item.moq}</td>
                ...
                <tfoot>
                    <tr className="font-bold">
                        <td colSpan={6} className="border border-black p-1 text-right">Total Amount</td>
