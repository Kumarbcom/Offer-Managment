                            ...
                            {(quotation.details || []).map((item, index) => {
                                ...
                                return (
                                    <tr key={index} className="divide-x divide-slate-200 hover:bg-slate-50/50 transition-colors odd:bg-slate-50/20">
                                        ...
                                        <td className="p-2 text-right text-slate-700 font-semibold bg-slate-50">{freightAmount > 0 ? freightAmount.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '-'}</td>
